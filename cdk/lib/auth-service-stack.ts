...
import { AUTHENTICATION_SERVICE_NAME, DELMITER, EC2_INSTANCE_PUBLIC_IP_OUTPUT, PACKAGE_DEPLOYMENT_BUCKET_ID, PACKAGE_DEPLOYMENT_BUCKET_BETA_NAME } from './constants';
